...
void menu(std::vector <Joueur> &joueurs, std::vector <Carte> &cartes, std::vector <Carte> &cartes2, int &nb_joueurs,std::vector <Carte> &secret, int& tour)
{
    ...
    while(!(mouse_b&1 and mouse_x>548 and mouse_x<649 and mouse_y>460 and mouse_y<555))
    {
        if(mouse_x>548 and mouse_x<649 and mouse_y>460 and mouse_y<555)
    ...
    if(mouse_b&1 and mouse_x>548 and mouse_x<649 and mouse_y>460 and mouse_y<555)
        launch(joueurs, cartes, cartes2, nb_joueurs, secret, tour);
...
void launch(std::vector <Joueur> &joueurs, std::vector <Carte> &cartes, std::vector <Carte> &cartes2, int &nb_joueurs,std::vector <Carte> &secret, int& tour)
{
    int choix =0 ;
    ...
    case 2 :
        ...
        readAll(joueurs, nb_joueurs, tour);
    ...
    ///Quitter
    case 5 :
        menu(joueurs, cartes, cartes2, nb_joueurs, secret, tour);
        break ;
    }
...
std::string saisie1joueur()
{
    ...
    textprintf_ex(buffer, font, 480, 90, makecol(77, 3, 18), -1, "Appuie sur ENTREE pour valider") ;
