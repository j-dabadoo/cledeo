    ...
    if(nb_depl>0 and keypressed())
    {
        ...
        case '0':
            ...
            if(key[KEY_UP])
            {
                ...
                if(m_posY-1 > 0 and pos=='0')
                {
                    m_posY--;
                    m_loca=pos;
                }
                ///La case suivante est une porte de salle
                else if(m_posY-1 > 0 and pos=='7')
                {
                    m_posY-=1;
                    m_loca=pos;
                }
            ...
            else if(key[KEY_DOWN])
            {
                ...
                ///La case suivante est dans la salle
                if(m_posY+1 <26 and pos=='0')
                {
                    m_posY++;
                    m_loca=pos;
                }
                ///La case suivante est la porte de la salle
                else if(m_posY+1 <26 and pos=='7')
                {
                    m_posY+=1;
                    m_loca=pos;
                }
            ...
            else if(key[KEY_LEFT])
            {
                ...
                ///La case suivante est dans la salle
                if(m_posX-1 > 0 and pos=='0')
                {
                    m_posX--;
                    m_loca=pos;
                }
                ///La case suivante est la porte de la salle
                else if(m_posX-1 > 0 and pos=='7')
                {
                    m_posX-=1;
                    m_loca=pos;
                }
            ...
            else if(key[KEY_RIGHT])
            {
                ...
                if(m_posX+1 < 26 and pos=='0')
                {
                    m_posX++;
                    m_loca=pos;
                }
                ///La case suivante est la porte de la salle
                else if(m_posX+1 <26 and pos=='7')
                {
                    m_posX+=1;
                    m_loca=pos;
                }
