...
Carte::Carte(std::string nom, BITMAP* image, std::string type)
{
    m_nom = nom ;
    m_image = image ;
    m_type = type ;
...
Arme::Arme(std::string nom, BITMAP* image, std::string type): Carte(nom, image, type)
{}

Lieu::Lieu(std::string nom, BITMAP* image, std::string type): Carte(nom,  image, type)
{}

Personnage::Personnage(std::string nom, BITMAP* image, std::string type): Carte(nom, image, type)
{}
