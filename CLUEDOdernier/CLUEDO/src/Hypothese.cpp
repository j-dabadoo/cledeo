...
void Hypothese::affichehypo(BITMAP* page, std::vector<Joueur>& joueurs, int& tour)
{
    clear_bitmap(page);
...
void Hypothese::actionhypo(int choixint, std::vector<Joueur>& joueurs, int& tour)
{
    ...
    std::cout << "validation du perso"<<std::endl;
    /// hypothese de l'arme
    while(valiarme!=1)
    {
    ...
    std::cout << "validation de l'arme"<<std::endl;
    ...
    std::cout << "validation du joueur"<<std::endl;
